 ...
 *                          condivisa.
 * \param      sem_ids      ID dei semafori.
 * \param[in]  P            Il numero di figli da creare.
 * \param      pid_to_pipe  Array per associare al pid la pipe corrispondente.
...
/*!
 * \brief      La funzione si occupa di tutto quello che avviene nel core del
 ...
 *
 * \param      multiply_array  L'array per i comandi di moltiplicazione
 * \param      sum_array       L'array per i comandi di somma
