...
/*!
 * @brief      Funzione che calcola il prodotto tra due matrici e lo salva in
...
/*!
 * @brief      Funzione che calcola la somma di una riga e aggiorna il valore
 *             nell'area di memoria predefinita
 *
